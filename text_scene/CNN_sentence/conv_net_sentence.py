...
def train_conv_net(datasets,
    ...
    parameters = [("image shape",img_h,img_w),("filter shape",filter_shapes),("hidden_units",hidden_units),
                  ...
                  ("conv_non_linear", conv_non_linear),("non_static", non_static),
    ...
    while (epoch < n_epochs):
        ...
        print 'epoch: %i, training time: %.2f secs, train perf: %.2f %%, val perf: %.2f %%' % (epoch, time.time()-start_time, train_perf * 100.,
        val_perf*100.)
...
if __name__=="__main__":
    ...
    if mode=="-nonstatic":
        ...
        non_static=False
    execfile("CNN_sentence/conv_net_classes.py")
    # python 3
    #with open("CNN_sentence/conv_net_classes.py") as f:
    #    code = compile(f.read(), "CNN_sentence/conv_net_classes.py", 'exec')
    #    exec(code)
